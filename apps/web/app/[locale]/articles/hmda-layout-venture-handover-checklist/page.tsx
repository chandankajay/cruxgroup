...
import { HmdaVentureHandoverContent } from "../../../../components/articles/hmda-venture-handover-content";
...
const SLUG = "hmda-layout-venture-handover-checklist";
...
export default async function HmdaVentureHandoverPage({
  params,
}: {
  params: Promise<{ locale: string }>;
  ...
  return (
    <TechnicalGuideArticleShell slug={SLUG} locale={locale}>
      <HmdaVentureHandoverContent locale={locale} />
    </TechnicalGuideArticleShell>
  );
}
