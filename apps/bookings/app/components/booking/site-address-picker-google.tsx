...
/** Production stack: Google Maps JS + Places + Geocoder (bill per Google pricing). */
export function SiteAddressPickerGoogle({
  address,
  onAddressChange,
  onLocationChange,
  onPincodeChange,
  ...
  if (!apiKey) {
    return (
      <PlainAddressInput
        ...
        warning="Set NEXT_PUBLIC_GOOGLE_MAPS_API_KEY when MAPS_PROVIDER=google."
      />
    );
  }
