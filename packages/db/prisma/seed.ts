...
const bookingLabels: SeedEntry[] = [
  ...
  { key: "LOGIN_ENTER_PIN", value: "Enter PIN", language: "en", app: "BOOKING" },
  { key: "LOGIN_SET_PIN", value: "Set PIN", language: "en", app: "BOOKING" },
  { key: "LOGIN_CONFIRM_PIN", value: "Confirm PIN", language: "en", app: "BOOKING" },
  { key: "LOGIN_FORGOT_PIN", value: "Forgot PIN?", language: "en", app: "BOOKING" },
  { key: "LOGIN_PIN_MISMATCH", value: "PINs do not match. Please try again.", language: "en", app: "BOOKING" },
  { key: "LOGIN_PIN_WEAK", value: "Choose a stronger PIN — avoid sequences like 1234.", language: "en", app: "BOOKING" },
  { key: "LOGIN_PIN_LOCKED", value: "Too many attempts. Try again after 15 minutes.", language: "en", app: "BOOKING" },
  { key: "LOGIN_SHARED_DEVICE_WARNING", value: "Don't set a PIN if others also use this phone or browser. Anyone who knows your PIN can access your account.", language: "en", app: "BOOKING" },
  { key: "PROFILE_CHANGE_PIN", value: "Change PIN", language: "en", app: "BOOKING" },
  ...
  { key: "EQUIPMENT_PER_HOUR", value: "/hr", language: "en", app: "BOOKING" },
...
const adminLabels: SeedEntry[] = [
  ...
  { key: "LOGIN_ENTER_PIN", value: "Enter PIN", language: "en", app: "ADMIN" },
  { key: "LOGIN_SET_PIN", value: "Set PIN", language: "en", app: "ADMIN" },
  { key: "LOGIN_CONFIRM_PIN", value: "Confirm PIN", language: "en", app: "ADMIN" },
  { key: "LOGIN_FORGOT_PIN", value: "Forgot PIN?", language: "en", app: "ADMIN" },
  { key: "LOGIN_PIN_MISMATCH", value: "PINs do not match. Please try again.", language: "en", app: "ADMIN" },
  { key: "LOGIN_PIN_WEAK", value: "Choose a stronger PIN — avoid sequences like 1234.", language: "en", app: "ADMIN" },
  { key: "LOGIN_PIN_LOCKED", value: "Too many attempts. Try again after 15 minutes.", language: "en", app: "ADMIN" },
  { key: "LOGIN_SHARED_DEVICE_WARNING", value: "Don't set a PIN if others also use this phone or browser. Anyone who knows your PIN can access your account.", language: "en", app: "ADMIN" },
